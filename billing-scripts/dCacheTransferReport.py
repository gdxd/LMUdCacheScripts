...
parser.add_option('-s','--start-date',help="The starting date: 2010-06-01", dest="dateStart", default=datetime.date.today())
parser.add_option('-e','--end-date', help="The ending date", dest="dateEnd", default=datetime.date.today())
...
try:
  ...
  if options.month!='empty':
    ...
    monthEntry=[str(datetime.date.today().year),str(datetime.date.today().month)]
...
for day in range(1,int(dateEnd.day)+1):
  print('')
  print('')
  transferList=[]
  requestList=[]
